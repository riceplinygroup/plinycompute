...
#ifndef TEST_81_SHARED_H
#define TEST_81_SHARED_H
...
int main(int argc, char* argv[]) {
    ...
    pdbClient.createSet<SharedEmployee>("by8_db", "output_set");
    ...
    pdbClient.registerType("libraries/libEmployeeIdentitySelection.so");
    pdbClient.registerType("libraries/libWriteEmployeeSet.so");
    ...
    Handle<Computation> myWriteSet = makeObject<WriteEmployeeSet>("by8_db", "output_set");
    ...
    if (printResult == true) {
        ...
        SetIterator<SharedEmployee> result =
                pdbClient.getSetIterator<SharedEmployee>("by8_db", "output_set");
