...
int main(int argc, char* argv[]) {
    ...
    if (whetherToAddData == true) {
        ...
        pdbClient.createDatabase("test93_db");

        // now, create the int set in that database
        pdbClient.createSet<StringIntPair>("test93_db", "test93_set1");

        // now, create the StringIntPair set in that database
        pdbClient.createSet<StringIntPair>("test93_db", "test93_set2");

        // now, create the String set in that database
        pdbClient.createSet<StringIntPair>("test93_db", "test93_set3");
    ...
    pdbClient.createSet<String>("test93_db", "output_set1");
    ...
    if (clusterMode == false) {
        ...
        pdbClient.removeSet("test93_db", "output_set1");
    }
