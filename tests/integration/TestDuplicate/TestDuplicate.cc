...
int main() {
  ...
  std::cout << "First address is " << (*supers)[0].getOffset() << std::endl;
  std::cout << "Ref assignment address is " << (*supers)[25].getOffset() << std::endl;

  std::cout << "Handle assignment address is " << (*supers)[75].getOffset() << std::endl;
