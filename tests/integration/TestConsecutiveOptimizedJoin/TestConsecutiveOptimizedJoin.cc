...
int main(int argc, char* argv[]) {
    ...
    if (whetherToAddData == true) {
        ...
        pdbClient.createDatabase("test94_db");

        // now, create the int set in that database
        pdbClient.createSet<StringIntPair>("test94_db", "test94_set1");

        // now, create the StringIntPair set in that database
        pdbClient.createSet<StringIntPair>("test94_db", "test94_set2");

        // now, create the String set in that database
        pdbClient.createSet<StringIntPair>("test94_db", "test94_set3");
    ...
    pdbClient.createSet<String>("test94_db", "output_set1");
    ...
    if (clusterMode == false) {
        ...
        pdbClient.removeSet("test94_db", "output_set1");
    }
