...
int main(int argc, char* argv[]) {
    ...
    if (whetherToAddData == true) {
        ...
        pdbClient.createDatabase("test67_db");

        // now, create a new set in that database
        pdbClient.createSet<Supervisor>("test67_db", "test67_set");
    ...
    pdbClient.createSet<DepartmentTotal>("test67_db", "output_set1");
    ...
    if (clusterMode == false) {
        ...
        pdbClient.removeSet("test67_db", "output_set1");
    }
