...
cluster that of eleven Amazon EC2 \texttt{m2.4xlarge} machines. All were
running Ubuntu 16.04, except linear algebra experiments on SciDB 14.8, which
required to use Ubuntu 12.04. Each machine had eight virtual cores, one SSD
...
experiment, details are listed in Sec.~\ref{sec:spark} in Appendix. We do not clear the OS buffer cache, so HDFS data can be
...
Sec.~\ref{sec:pc-object1}, storing a contiguous rectangular sub-block
of the matrix.
