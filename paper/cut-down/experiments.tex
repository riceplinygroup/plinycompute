...
cluster that of eleven Amazon EC2 \texttt{m2.4xlarge} machines. All are
running Ubuntu 16.04, except linear algebra experiments on SciDB, which
requires to use Ubuntu 12.04. Each machine had eight virtual cores, one SSD
