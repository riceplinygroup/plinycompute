...
\vspace{3pt}
\noindent
(3) The \emph{PC Cluster}, which is a distributed query processing
  system for big data analytics.
  It consists of an optimizer for TCAP
  programs, 
a catalog server tasked with
serving system meta-data, a
distributed storage system that
contains a buffer pool to buffer writes or cache data in pages, and a
...
We also benchmark the performance of several standard machine learning codes written on top of PC.
