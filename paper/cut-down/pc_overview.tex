...
\noindent
To create a load of such data into a PC compute cluster, we might write the following code:
...
This illustrates the principle of \emph{minimal cost data movement}.
...
but the benefit is nearly minimal-cost memory management within the block.
