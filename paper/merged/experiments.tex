...
raw array data is directly passed to Eigen library for processing.
...
$10^6$ data points were used.  For Gram matrix and linear regression, SystemML V0.9 on Hadoop,
