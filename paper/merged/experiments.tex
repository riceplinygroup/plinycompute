...
2.1.0). The configuration of the Spark cluster such as number of executors,
...
experiments, data were serialized in Kryo format. 

Other Spark parameters such as parallelsim,
...
Section~\ref{sec:pc-object1}, storing a contiguous rectangular sub-block of the matrix:
...
The actual data stored in a \texttt{MatrixBlock} object should be small enough to fit completely in 
...
We wished to compared our LDA implementation with an algorithmically equivalent Spark implementation.  Unfortunately,
