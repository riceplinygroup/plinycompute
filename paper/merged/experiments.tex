...
\vspace{5pt}
As shown in Table~\ref{fig:LOC}, we use similar (or even fewer) number of lines of C++
...
same computation logic, PC requires $2\times$ to $3\times$ more
...
library for those functions; (3) Some logic (e.g. dirichlet sampling) are used
