...
implement GMM using the Expectation Maximization (EM) algorithm to be
...
We compare PC with Spark MLLib (using Spark 2.1.0) for $10^7$ data
...
carefully tune the data partition size to make sure there are enough
