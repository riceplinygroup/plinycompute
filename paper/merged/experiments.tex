...
select eight representative applications from three categories
...
object model has a significant performance improvement, which are
brought by the native code advantage and PC object model features such
as no serialization/deserialization overhead for data shuffling. It
