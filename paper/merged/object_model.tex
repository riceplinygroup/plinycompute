\section{The PC Object Model} \label{sec:ObjectModel}
...
The key principle underlying the PC object model is \emph{minimal-cost data movement}.  That is, once a data object
...
At first glance, it would seem to be impossible to offer minimal-cost data movement while allowing a programmer to create and manipulate such objects.  
...
In order to guarantee minimal-cost data movement,
...
minimal-cost data movement---an allocation block should be transferable across processes and immediately usable with no pre- or post-processing---one
...
the current block is minimal-cost copy-able and movable.  

The reader may question whether this actually saves anything.  After
