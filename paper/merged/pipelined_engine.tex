...
To guarantee this,
PC obtains from Pangea a page for writing output objects for each thread, and places the current \texttt{Object} allocation block
onto this page. 
...
input data from Pangea, and then repeatedly creates vectors of \texttt{Handle}s to the \texttt{Object}s on
