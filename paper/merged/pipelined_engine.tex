...
processing in Section~\ref{sec:implementation} of the Appendix.
...
and can only produce output data.  Thus, any additional pages the pipeline is used to produce
