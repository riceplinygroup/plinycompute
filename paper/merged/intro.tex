...
The PC \texttt{Object} model is tightly coupled with
...
Further, PC gives a programmer fine-grained control of the systems memory management and PC \texttt{Object} re-use policies.
