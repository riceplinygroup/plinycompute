 ...
 */
#if !BOOST_ENDIAN_BIG_BYTE && !BOOST_ENDIAN_BIG_WORD && !BOOST_ENDIAN_LITTLE_BYTE && \
...
#if BOOST_ARCH_M68K || BOOST_ARCH_PARISC || BOOST_ARCH_SPARC || BOOST_ARCH_SYS370 || \
    BOOST_ARCH_SYS390 || BOOST_ARCH_Z
#undef BOOST_ENDIAN_BIG_BYTE
#define BOOST_ENDIAN_BIG_BYTE BOOST_VERSION_NUMBER_AVAILABLE
#endif
#if BOOST_ARCH_AMD64 || BOOST_ARCH_IA64 || BOOST_ARCH_X86 || BOOST_ARCH_BLACKFIN
#undef BOOST_ENDIAN_LITTLE_BYTE
#define BOOST_ENDIAN_LITTLE_BYTE BOOST_VERSION_NUMBER_AVAILABLE
#endif
#endif
