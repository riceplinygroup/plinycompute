...
#define BOOST_PREDEF_MAKE_0X_VRP(V) \
    BOOST_VERSION_NUMBER((V & 0xF00) >> 8, (V & 0xF0) >> 4, (V & 0xF))
/*` `BOOST_PREDEF_MAKE_0X_VVRP(V)` */
#define BOOST_PREDEF_MAKE_0X_VVRP(V) \
    BOOST_VERSION_NUMBER((V & 0xFF00) >> 8, (V & 0xF0) >> 4, (V & 0xF))
/*` `BOOST_PREDEF_MAKE_0X_VRPP(V)` */
#define BOOST_PREDEF_MAKE_0X_VRPP(V) \
    BOOST_VERSION_NUMBER((V & 0xF000) >> 12, (V & 0xF00) >> 8, (V & 0xFF))
...
#define BOOST_PREDEF_MAKE_0X_VVRRP(V) \
    BOOST_VERSION_NUMBER((V & 0xFF000) >> 12, (V & 0xFF0) >> 4, (V & 0xF))
...
#define BOOST_PREDEF_MAKE_10_VRP(V) \
    BOOST_VERSION_NUMBER(((V) / 100) % 10, ((V) / 10) % 10, (V) % 10)
/*` `BOOST_PREDEF_MAKE_10_VRP000(V)` */
#define BOOST_PREDEF_MAKE_10_VRP000(V) \
    BOOST_VERSION_NUMBER(((V) / 100000) % 10, ((V) / 10000) % 10, ((V) / 1000) % 10)
/*` `BOOST_PREDEF_MAKE_10_VRPP(V)` */
#define BOOST_PREDEF_MAKE_10_VRPP(V) \
    BOOST_VERSION_NUMBER(((V) / 1000) % 10, ((V) / 100) % 10, (V) % 100)
/*` `BOOST_PREDEF_MAKE_10_VRR(V)` */
#define BOOST_PREDEF_MAKE_10_VRR(V) BOOST_VERSION_NUMBER(((V) / 100) % 10, (V) % 100, 0)
/*` `BOOST_PREDEF_MAKE_10_VRRPP(V)` */
#define BOOST_PREDEF_MAKE_10_VRRPP(V) \
    BOOST_VERSION_NUMBER(((V) / 10000) % 10, ((V) / 100) % 100, (V) % 100)
/*` `BOOST_PREDEF_MAKE_10_VRR000(V)` */
#define BOOST_PREDEF_MAKE_10_VRR000(V) \
    BOOST_VERSION_NUMBER(((V) / 100000) % 10, ((V) / 1000) % 100, 0)
...
#define BOOST_PREDEF_MAKE_10_VVRRPP(V) \
    BOOST_VERSION_NUMBER(((V) / 10000) % 100, ((V) / 100) % 100, (V) % 100)
...
#define BOOST_PREDEF_MAKE_DATE(Y, M, D) \
    BOOST_VERSION_NUMBER((Y) % 10000 - 1970, (M) % 100, (D) % 100)
/*` `BOOST_PREDEF_MAKE_YYYYMMDD(V)` */
#define BOOST_PREDEF_MAKE_YYYYMMDD(V) \
    BOOST_PREDEF_MAKE_DATE(((V) / 10000) % 10000, ((V) / 100) % 100, (V) % 100)
