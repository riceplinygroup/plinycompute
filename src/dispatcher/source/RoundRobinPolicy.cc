...
void RoundRobinPolicy :: updateStorageNodes(Handle<Vector<Handle<NodeDispatcherData>>> activeStorageNodesRaw) {
...
std::vector<NodePartitionDataPtr> RoundRobinPolicy :: createNodePartitionData(Handle<Vector<Handle<NodeDispatcherData>>> storageNodes) {
...
NodePartitionDataPtr RoundRobinPolicy :: updateExistingNode(NodePartitionDataPtr newNode, NodePartitionDataPtr oldNode) {
