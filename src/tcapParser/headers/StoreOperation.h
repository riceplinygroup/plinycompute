...
namespace pdb_detail
{
    ...
    private:
        ...
        */
        // private because throws exception and PDB style guile forbids exceptions from crossing API boundaries.
        ...
        // for constructor
        friend shared_ptr<StoreOperation> makeStoreOperation(class TcapTokenStream &tokens,
