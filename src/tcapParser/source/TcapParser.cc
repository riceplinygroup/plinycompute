...
namespace pdb_detail
{
     ...
     */
    TcapToken consumeNext(TcapTokenStream &tokenStream, TcapTokenType expectedType1, TcapTokenType expectedType2)
    {
    ...
    /**
     * Consumes the next token in the stream (assumed IDENTIFIER_TYPE) and creates a TcapIdentifier from the symbol.
     *
     * Assumes that a next token is avaialbe in the stream and that it is of type TcapTokenType::IDENTIFIER_TYPE.
     ...
     *
     * until a comma token is not observed after the last consumed identifier or the stream is excausted.
     *
     * If the first token read from the stream is not an identifier token, a string exception is generated.
    ...
    /**
     * Consumes the next tokens in the stream that form  a retain clause and return a representation of that clause.
     *
     * Assumes that the next token in the stream is of type TcapTokenType::RETAIN_TYPE and consumes it. If the next
     * token of the stream is not of type TcapTokenType::RETAIN_TYPE or the stream is empty, a string exception
     * is generated.
     *
     * Aftewords, there are three potential cases depending on the token following TcapTokenType::RETAIN_TYPE.
     *
     ...
     *
     * If the next token or tokens does not conform to any of these expected paterns, a string exception is generated.
     *
    ...
    {
        consumeNext(tokens, TcapTokenType::RETAIN_TYPE); // consume the "retain" token assumed to be next
    ...
    /**
     * Consumes the next tokens in the stream that form an ApplyOperation and return a representation of that
     * operation.
     *
     * If the given stream is empty, a string exception is generated.
     *
     * If the given stream does not start with tokens that form an ApplyOperation, a string exception is generated.
     *
    ...
    shared_ptr<ApplyOperation> makeApplyOperation(TcapTokenStream &tokens)
    {
        ...
        TcapToken applyTargetType = consumeNext(tokens, TcapTokenType::FUNC_TYPE, TcapTokenType::METHOD_TYPE);
    ...
    /**
     * Consumes the next tokens in the stream that form a HoistOperation and return a representation of that
     * operation.
     *
     * If the given stream is empty, a string exception is generated.
     *
     * If the given stream does not start with tokens that form a HoistOperation, a string exception is generated.
     *
    ...
    /**
     * Consumes the next tokens in the stream that form a LoadOperation and return a representation of that
     * operation.
     *
     * If the given stream is empty, a string exception is generated.
     *
     * If the given stream does not start with tokens that form a LoadOperation, a string exception is generated.
     *
    ...
    /**
     * Consumes the next tokens in the stream that form a StoreOperation and return a representation of that
     * operation.
     *
     * If the given stream is empty, a string exception is generated.
     *
     * If the given stream does not start with tokens that form a StoreOperation, a string exception is generated.
     *
    ...
    StoreOperationPtr makeStoreOperation(TcapTokenStream &tokens, shared_ptr<vector<TcapAttribute>> attributes)
    {
    ...
    /**
     * Consumes the next tokens in the stream that form a FilterOperation and return a representation of that
     * operation.
     *
     * If the given stream is empty, a string exception is generated.
     *
     * If the given stream does not start with tokens that form a FilterOperation, a string exception is generated.
     *
    ...
    /**
     * Consumes the next tokens in the stream that form a BinaryOperation and return a representation of that
     * operation.
     *
     * A BinaryOperation may be one of the following (only one currently exists, but will grow in the future):
     *
     *     GreaterThanOp
     *
     *
    ...
    /**
     * Consumes the next tokens in the stream that form a TableExpression and return a representation of that
     * expression.
     *
    ...
    /**
     * Consumes the next tokens in the stream that form a TableAssignment and return a representation of that
     * assignment.
     *
     * If the given stream is empty, a string exception is generated.
     *
     * If the given stream does not start with tokens that form a TableAssignment, a string exception is generated.
     *
     ...
     */
    TableAssignmentPtr makeTableAssignment(TcapTokenStream &tokens, shared_ptr<vector<TcapAttribute>> attributes)
    {
    ...
    /**
     * Consumes the next tokens in the stream that form a TcapAttribute and return a representation of that
     * attribute.
     *
     * If the given stream is empty, a string exception is generated.
     *
     * If the given stream does not start with tokens that form a TcapAttribute, a string exception is generated.
     *
    ...
    /**
     * Consumes the next tokens in the stream that form a TcapStatement and return a representation of that
