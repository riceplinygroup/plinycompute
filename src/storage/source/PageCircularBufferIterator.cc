...
#include <iostream>
using namespace std;
PageCircularBufferIterator::PageCircularBufferIterator(unsigned int id, PageCircularBufferPtr buffer,
 ...
 * Solution 2: allow that you may get a nullptr by calling next(), and it is your responsibility to check that!
 * 
