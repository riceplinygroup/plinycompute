...
public:
	...
	Map<String, Vector<OptimizedEmployee>> employees; //for each supervisor in this department, the list of employees	
	ENABLE_DEEP_COPY
...
inline Map<String, Vector<OptimizedEmployee>> &operator+ (Map<String, Vector<OptimizedEmployee>> &lhs, Map<String, Vector<OptimizedEmployee>> &rhs) {
       auto iter = rhs.begin();
       while (iter != rhs.end()) {
