...
#ifndef PDBHANDLE_PROTOTYPE_H
#define PDBHANDLE_PROTOTYPE_H
...
// type of the object inside of the template, so that we can perform operations on it at a later time.

//  PRELOAD %Handle <Nothing>%
