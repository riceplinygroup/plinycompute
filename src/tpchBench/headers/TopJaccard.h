...
public:
        ...
        TopJaccard (int kIn, Vector <int> partsToCheckForIn) : k (kIn), partsToCheckFor (partsToCheckForIn) {}

        Lambda <TopKQueue <double, Handle <AllParts>>> getValueProjection (Handle <Customer> aggMe) override {
