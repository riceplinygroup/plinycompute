...
// this class encapsulates a shuffler to pick up join maps in the input pages that belongs to the shuffler's destination node and create them again in a set of output pages. So the set of output pages are belonging to the same destination node.
class SinkShuffler {
