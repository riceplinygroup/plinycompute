...
tcapString << std :: endl;
                ...
                //TODO: add Flatten
                newTupleSetName = "flattenedOutFor"+getComputationType()+std::to_string(computationLabel);
                std :: string newOutputColumnName = "flattened_"+addedOutputColumnName;
                tcapString += newTupleSetName  + "(" + newOutputColumnName + ") <= FLATTEN (" + outputTupleSetName + "(" + addedOutputColumnName + "), " + outputTupleSetName + "(), '" + getComputationType() + "_" + std :: to_string(computationLabel) + "')\n";
