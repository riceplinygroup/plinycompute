...
using namespace std;
    ...
    void CatalogStandardNodeMetadata :: setValues(string nodeIdValue, string nodeIPValue, int nodePortValue, string nodeNameValue, string nodeTypeValue, int nodeStatusValue) {
        nodeId = nodeIPValue;
        nodeIP = nodeIPValue;
        nodePort = nodePortValue;
        nodeName = nodeNameValue;
