...
using namespace std;
    ...
    CatalogStandardSetMetadata :: CatalogStandardSetMetadata(string pdbSetIdIn, string pdbSetKeyIn, string pdbSetNameIn,
    ...
    CatalogStandardSetMetadata :: CatalogStandardSetMetadata(const CatalogStandardSetMetadata& pdbSetToCopy){
    ...
    void CatalogStandardSetMetadata :: setValues(string pdbSetIdIn, string pdbSetKeyIn, string pdbSetNameIn,
