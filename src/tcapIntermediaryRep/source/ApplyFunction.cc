...
namespace pdb_detail
{
    ...
    ApplyFunctionPtr makeApplyFunction(const string &executorId, const string &functionId, const string &outputTableId,
                      ...
                      TableColumns inputColumns, shared_ptr<vector<TableColumn>> columnsToCopyToOutputTable)
    {
        try
        {
            return ApplyFunctionPtr(new ApplyFunction(executorId, functionId, outputTableId, outputColumnId,
                                                      inputColumns, columnsToCopyToOutputTable));
        }
    ...
    ApplyFunction::ApplyFunction(const string &executorId, const string &functionId, const string &outputTableId,
