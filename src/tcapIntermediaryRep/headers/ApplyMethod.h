...
namespace pdb_detail
{
    ...
    private:
         ...
         */
        ApplyMethod(const string &executorId, const string &functionId, const string &outputTableId,
                    const string &outputColumnId, TableColumns inputColumns,
                    shared_ptr<vector<TableColumn>> columnsToCopyToOutputTable);

        friend shared_ptr<ApplyMethod> makeApplyMethod(const string &executorId, const string &functionId,
