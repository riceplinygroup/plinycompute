...
void parseAtomicComputationList(AtomicComputationList * result) {
	...
	for (int i = 0; i < allScanSets.size(); i++) {	
		...
		vector <AtomicComputationPtr> consumingAtomicComputations = result->getConsumingAtomicComputations(outputName);
		for (int j = 0; j < consumingAtomicComputations.size(); j++) {
			parseAtomicComputation(result, consumingAtomicComputations.at(j), outputName, allScanSets.at(i));
		}
	}	
}
...
//*
	...
	attAccess_0ExtractedForJoinComp2(in0,att_ExtractedFor_name) <= APPLY (inputDataForScanUserSet_0(in0), inputDataForScanUserSet_0(in0), 'JoinComp_2', 'attAccess_0')	\n\
	attAccess_0ExtractedForJoinComp2_hashed(in0,att_ExtractedFor_name_hash) <= HASHLEFT (attAccess_0ExtractedForJoinComp2(att_ExtractedFor_name), attAccess_0ExtractedForJoinComp2(in0), 'JoinComp_2', '==_2')	\n\
	attAccess_1ExtractedForJoinComp2(in1,att_ExtractedFor_starName) <= APPLY (inputDataForScanUserSet_1(in1), inputDataForScanUserSet_1(in1), 'JoinComp_2', 'attAccess_1')	\n\
	attAccess_1ExtractedForJoinComp2_hashed(in1,att_ExtractedFor_starName_hash) <= HASHRIGHT (attAccess_1ExtractedForJoinComp2(att_ExtractedFor_starName), attAccess_1ExtractedForJoinComp2(in1), 'JoinComp_2', '==_2')	\n\
	JoinedFor_equals2JoinComp2(in0, in1) <= JOIN (attAccess_0ExtractedForJoinComp2_hashed(att_ExtractedFor_name_hash), attAccess_0ExtractedForJoinComp2_hashed(in0), attAccess_1ExtractedForJoinComp2_hashed(att_ExtractedFor_starName_hash), attAccess_1ExtractedForJoinComp2_hashed(in1), 'JoinComp_2') \n\
	JoinedFor_equals2JoinComp2_WithLHSExtracted(in0,in1,LHSExtractedFor_2_2) <= APPLY (JoinedFor_equals2JoinComp2(in0), JoinedFor_equals2JoinComp2(in0,in1), 'JoinComp_2', 'attAccess_0')	\n\
	JoinedFor_equals2JoinComp2_WithBOTHExtracted(in0,in1,LHSExtractedFor_2_2,RHSExtractedFor_2_2) <= APPLY (JoinedFor_equals2JoinComp2_WithLHSExtracted(in1), JoinedFor_equals2JoinComp2_WithLHSExtracted(in0,in1,LHSExtractedFor_2_2), 'JoinComp_2', 'attAccess_1')	\n\
	JoinedFor_equals2JoinComp2_BOOL(in0,in1,bool_2_2) <= APPLY (JoinedFor_equals2JoinComp2_WithBOTHExtracted(LHSExtractedFor_2_2,RHSExtractedFor_2_2), JoinedFor_equals2JoinComp2_WithBOTHExtracted(in0,in1), 'JoinComp_2', '==_2')	\n\
	JoinedFor_equals2JoinComp2_FILTERED(in0, in1) <= FILTER (JoinedFor_equals2JoinComp2_BOOL(bool_2_2), JoinedFor_equals2JoinComp2_BOOL(in0, in1), 'JoinComp_2')	\n\
	nativ_3OutForJoinComp2 (nativ_3_2OutFor) <= APPLY (JoinedFor_equals2JoinComp2_FILTERED(in0), JoinedFor_equals2JoinComp2_FILTERED(), 'JoinComp_2', 'native_lambda_3')	\n\
	attAccess_0OutForSelectionComp3(nativ_3_2OutFor,att_OutFor_birthYear) <= APPLY (nativ_3OutForJoinComp2(nativ_3_2OutFor), nativ_3OutForJoinComp2(nativ_3_2OutFor), 'SelectionComp_3', 'attAccess_0')	\n\
	attAccess_1OutForSelectionComp3(nativ_3_2OutFor,att_OutFor_birthYear,att_OutFor_checkBirthYear) <= APPLY (attAccess_0OutForSelectionComp3(nativ_3_2OutFor), attAccess_0OutForSelectionComp3(nativ_3_2OutFor,att_OutFor_birthYear), 'SelectionComp_3', 'attAccess_1')	\n\
