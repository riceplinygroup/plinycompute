 ...
 *
 *  if this is the catalog instance of a worker node, it will receive a metadata registration
...
namespace pdb {
    ...
    public:
         ...
         * removes a set for a database in a node in the cluster returns true on success
         */
