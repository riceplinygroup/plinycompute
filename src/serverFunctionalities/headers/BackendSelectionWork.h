...
public:
    ...
    BackendSelectionWork(PageCircularBufferIteratorPtr iterIn, DatabaseID destDatabaseIdIn,
    	UserTypeID destTypeIdIn, SetID destSetIdIn, pdb :: HermesExecutionServer * serverIn,
    	int & counterIn, pdb :: Handle <pdb :: Selection <pdb :: Object, pdb :: Object>> myQueryIn)
    	: iter(iterIn)
