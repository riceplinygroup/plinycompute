...
public:
     ...
     * @param receivers Vector of "ip:host" of the nodes to receive the broadcast. If the vector is empty,
     *                  broadcast will simply broadcast the messages to the entire cluster.
