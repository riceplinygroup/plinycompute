...
int main(int argc, char* argv[]) {
    ...
    std::cout << "Firstly, make sure to run bin/test23 in a different window to provide a "
    ...
    std::cout << "Thirdly, make sure to run bin/test26 first to add data to the set created in "
                 "last step.\n";
