...
int main (int argc, char * argv[]) {
   ...
   Handle <JoinMap <JoinTuple<String, JoinTuple<int, JoinTuple<double, char[0]>>>>> myMap = makeObject <JoinMap <JoinTuple<String, JoinTuple<int, JoinTuple<double, char[0]>>>>> ();
   ...
   Handle <JoinMap <JoinTuple<String, JoinTuple<int, JoinTuple<double, char[0]>>>>> myCopiedMap = ((Record <JoinMap<JoinTuple<String, JoinTuple<int, JoinTuple<double, char[0]>>>>> *) myOtherBlock)->getRootObject();
   ...
   Handle <JoinMap <JoinTuple<String, JoinTuple<int, JoinTuple<double, char[0]>>>>> myNewMap = makeObject <JoinMap <JoinTuple<String, JoinTuple<int, JoinTuple<double, char[0]>>>>> ();
   for (JoinMapIterator<JoinTuple<String, JoinTuple<int, JoinTuple<double, char[0]>>>> iter = myCopiedMap->begin(); iter != myCopiedMap->end(); ++iter) {
        JoinRecordList<JoinTuple<String, JoinTuple<int, JoinTuple<double, char[0]>>>> * myList = *iter;
        ...
        for (int i = 0; i < mySize; i++) {
            JoinTuple<String, JoinTuple<int, JoinTuple<double, char[0]>>> &temp = myNewMap->push(myHash);
   ...
   for (JoinMapIterator<JoinTuple<String, JoinTuple<int, JoinTuple<double, char[0]>>>> iter = myNewMap->begin(); iter != myNewMap->end(); ++iter) {
        JoinRecordList<JoinTuple<String, JoinTuple<int, JoinTuple<double, char[0]>>>> * myList = *iter;
        size_t mySize = myList->size();
        size_t myHash = myList->getHash();
        std :: cout << "list size: " << mySize << std :: endl;
