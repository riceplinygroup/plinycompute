...
int main(int argc, char* argv[]) {
    ...
    if (whetherToAddData == true) {
        ...
        if (!pdbClient.createSet<int>("test76_db", "test76_set1", errMsg)) {
        ...
        if (!pdbClient.createSet<StringIntPair>("test76_db", "test76_set2", errMsg)) {
            cout << "Not able to create set: " + errMsg;
            exit(-1);
        } else {
        ...
        if (!pdbClient.createSet<String>("test76_db", "test76_set3", errMsg)) {
            cout << "Not able to create set: " + errMsg;
            exit(-1);
        } else {
    ...
    if (!pdbClient.createSet<String>("test76_db", "output_set1", errMsg)) {
        cout << "Not able to create set: " + errMsg;
        exit(-1);
    } else {
        cout << "Created set.\n";
