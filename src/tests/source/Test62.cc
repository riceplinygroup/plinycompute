...
int main (int argc, char * argv[]) {
       ...
       Handle<Computation> myScanSet = makeObject<ScanEmployeeSet>("chris_db", "chris_set");
        ...
        std :: string myScanSetTcapString = myScanSet->toTCAPString (inputTupleSets1, 0, outputTupleSetName, outputColumnNames, addedOutputColumnName);
        ...
        std :: string myQueryString = myQuery->toTCAPString (inputTupleSets2, 1, outputTupleSetName, outputColumnNames, addedOutputColumnName);
        ...
        std :: string myWriteSetTcapString = myWriteSet->toTCAPString (inputTupleSets3, 2, outputTupleSetName, outputColumnNames, addedOutputColumnName);
