...
int main(int argc, char* argv[]) {
    ...
    if (printResult == true) {
        ...
        SetIterator<MatrixBlock> input1 =
            myClient.getSetIterator<MatrixBlock>("LA15_db", "LA_input_set1");
        ...
        SetIterator<MatrixBlock> input2 =
            myClient.getSetIterator<MatrixBlock>("LA15_db", "LA_input_set2");
        ...
        SetIterator<MatrixBlock> result =
            myClient.getSetIterator<MatrixBlock>("LA15_db", "LA_ScaleProduct_set");
