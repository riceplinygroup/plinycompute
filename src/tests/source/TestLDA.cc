...
int main(int argc, char* argv[]) {
    ...
    Handle<Computation> myWriter =
        makeObject<WriteIntDoubleVectorPairSet>("LDA_db", "LDA_doc_topic_prob_test_set_0");
    ...
    Handle<Computation> myWriter2 =
        makeObject<WriteTopicsPerWord>("LDA_db", "LDA_word_topic_prob_test_set_0");
    ...
    for (int n = 0; n < iter; n++) {
        ...
        Handle<Computation> myScanDocTopicProb = makeObject<ScanIntDoubleVectorPairSet>(
            "LDA_db", docTopicSet + "_" + std::to_string(myNum));
        Handle<Computation> myScanWordTopicProb =
            makeObject<ScanTopicsPerWord>("LDA_db", wordTopicSet + "_" + std::to_string(myNum));
        ...
        Handle<Computation> myWriter = makeObject<WriteIntDoubleVectorPairSet>(
            "LDA_db", docTopicSet + "_" + std::to_string((myNum + 1) % 2));
        myWriter->setInput(myDocTopicProb);
        ...
        */
        ...
        Handle<Computation> myWriter2 = makeObject<WriteIntDoubleVectorPairSet>(
            "LDA_db", wordTopicSet + "_" + std::to_string((myNum + 1) % 2));
        myWriter2->setInput(myWordTopicProb);
        ...
        std::cout << "The query " << to + 2 << " and " << to + 3
                  << " are executed successfully!\n\n";


        temp.clearSet("LDA_db",
                      docTopicSet + "_" + std::to_string(myNum),
                      "pdb::IntDoubleVectorPair",
                      errMsg);
        temp.clearSet("LDA_db",
                      wordTopicSet + "_" + std::to_string(myNum),
                      "pdb::IntDoubleVectorPair",
                      errMsg);
...
Assignment: ";
    ...
    */
    ...
    SetIterator<IntDoubleVectorPair> initTopicProbResult =
        myClient.getSetIterator<IntDoubleVectorPair>("LDA_db",
                                                     wordTopicSet + "_" + std::to_string(iter % 2));
    for (Handle<IntDoubleVectorPair> a : initTopicProbResult) {
