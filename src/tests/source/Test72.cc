...
//by Jia, Mar 2017
//to test AllSelection using new pipeline stuff and new end-to-end framework
...
int main (int argc, char * argv[]) {
	...
	// register this query class
        catalogClient.registerType ("libraries/libAllSelection.so", errMsg);
	...
	QueryClient myClient (8108, "localhost", clientLogger, true);
        ...
        Handle<Computation> myQuery = makeObject<AllSelection>();
