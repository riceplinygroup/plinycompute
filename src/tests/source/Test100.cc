...
//		printf("full hostname is: %s\n", h->h_name);
		...
		std::cout << "Server Port Number is: " << portNumber << ". Master flag is: " << isMaster << std::endl;
		...
		cout << "Provide: portNumber, masterNodeHostName, masterNodePort,  and a integer:  1 for MasterNode, 0 for SlaveNode" << "\n";
	}
}
