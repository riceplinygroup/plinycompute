...
int main(int argc, char* argv[]) {
    ...
    if (whetherToAddData == true) {
        ...
        if (numOfMb > 0) {
            /*
                        ...
                        std:: cout << "Number of MB: " << numOfMb << " Number of Iterations: " <<
    ...
    */
    ...
    Handle<Computation> myWriter2 =
        makeObject<WriteIntDoubleVectorPairSet>("LDA_db", "LDA_word_topic_prob_test_set_0");
    ...
    for (int n = 0; n < iter; n++) {
        ...
        for (int j = 0; j < smallIter; j++) {
            ...
            if (j == 0) {
                ...
                Handle<Computation> myScanWordTopicProb = makeObject<ScanIntDoubleVectorPairSet>(
                    "LDA_db", wordTopicSet + "_" + std::to_string(myNum));
                //		Handle <Computation> myDocWordTopicJoin = makeObject <LDADocWordTopicJoin>
                //();
        ...
        term << green << "The query " << n * 2 + 2 << " and " << n * 2 + 3
