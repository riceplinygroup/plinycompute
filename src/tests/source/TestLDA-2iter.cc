 ...
 *                                                                           *
 *****************************************************************************/
#ifndef TEST_LDA_2_ITER_CC
#define TEST_LDA_2_ITER_CC
...
int main(int argc, char* argv[]) {
    ...
    if (whetherToAddData == true) {
        ...
        if (numOfMb > 0) {
            ...
            for (int num = 0; num < numIterations; num++) {
                ...
                pdb::makeObjectAllocatorBlock(blockSize * 1024 * 1024, true);
                pdb::Handle<pdb::Vector<pdb::Handle<int>>> storeMe =
    ...
    */
    ...
    /*
    Handle <Computation> myWriter = makeObject<WriteIntDoubleVectorPairSet>("LDA_db",
    "LDA_doc_topic_prob_test_set");
    ...
    SetIterator <IntDoubleVectorPair> result1 = myClient.getSetIterator <IntDoubleVectorPair>
    ("LDA_db", "LDA_doc_topic_prob_test_set");
    ...
    */
    ...
    Handle<Computation> myWordTopicProb =
        makeObject<LDAInitialWordTopicProbMultiSelection>(numTopic);
    myWordTopicProb->setInput(myMetaScanSet);
    /*
    Handle <Computation> myWriter2 = makeObject<WriteIntDoubleVectorPairSet>("LDA_db",
    "LDA_word_topic_prob_test_set");
    ...
    SetIterator <IntDoubleVectorPair> result2 = myClient.getSetIterator <IntDoubleVectorPair>
    ("LDA_db", "LDA_word_topic_prob_test_set");
    ...
    */
    ...
    for (int n = 0; n < iter; n++) {
        ...
        //	Handle<Computation> myScanSet = makeObject<ScanLDADocumentSet>("LDA_db",
        //"LDA_input_set");
        //	Handle<Computation> myScanDocTopicProb =
        //makeObject<ScanIntDoubleVectorPairSet>("LDA_db", "LDA_doc_topic_prob_test_set");
        //	Handle<Computation> myScanWordTopicProb =
        //makeObject<ScanIntDoubleVectorPairSet>("LDA_db", "LDA_word_topic_prob_test_set");
        ...
        */
        ...
        //(numTopic);
        Handle<Computation> myDocTopicCountAgg =
            makeObject<LDADocTopicFromCountAggregate>(numTopic);
        ...
        //makeObject<WriteIntDoubleVectorPairSet>("LDA_db", "LDA_doc_topic_prob_test_set");
        //    	    	myWriter->setInput(myDocTopicProb);
    ...
    //	std :: cout << "The query " << to+3 << " is executed successfully!" << std :: endl;
        std :: cout << "The query " << to+2 << " and " << to+3 << " is executed successfully!" <<
    std :: endl;
    ...
    Handle<Computation> myWriter =
        makeObject<WriteIntDoubleVectorPairSet>("LDA_db", "LDA_word_topic_prob_test_set");
    //	myWriter->setInput(myWordTopicProb);
    myWriter->setInput(tempOut[to + 1]);


    //		Handle <Computation> myWriter = makeObject<WriteLDATopicWordProbSet>("LDA_db",
    //"LDA_word_topic_prob_test_set");
    //	myWriter->setInput(myWordTopicProbThis);
    //		myWriter->setInput(myTopicWordProb);


    /*
    Handle <Computation> myWriter = makeObject<WriteLDADocWordTopicAssignmentSet>("LDA_db",
    "LDA_topic_join_test_set");
    ...
    */
    ...
    SetIterator <IntDoubleVectorPair> initTopicProbResult =
                    myClient.getSetIterator <IntDoubleVectorPair> ("LDA_db",
"LDA_doc_topic_prob_test_set");
    for (Handle<IntDoubleVectorPair> a : initTopicProbResult) {
//		term << red << "Doc ID: " << a->getDoc() << "Word ID: " << a->getWord() << "Topic
Assignment: ";
        term << red << "Doc ID: " << a->getInt() << " Topic Probability: ";
    //	a->getTopicAssignment().print();
        a->getVector().print();
        term << std::endl;
    }
    ...
    */
    ...
    int totOut = 0;
    SetIterator<IntDoubleVectorPair> initTopicProbResult =
        myClient.getSetIterator<IntDoubleVectorPair>("LDA_db", "LDA_word_topic_prob_test_set");
    for (Handle<IntDoubleVectorPair> a : initTopicProbResult) {
    ...
    SetIterator <LDATopicWordProb> initTopicProbResult =
                    myClient.getSetIterator <LDATopicWordProb> ("LDA_db",
    "LDA_word_topic_prob_test_set");
...
*
    SetIterator <DoubleVector> input = myClient.getSetIterator <DoubleVector> ("LDA_db",
"LDA_input_set");
...
*
    ...
    SetIterator <KMeansAggregateOutputType> result = myClient.getSetIterator
<KMeansAggregateOutputType> ("LDA_db", "LDA_output_set");
