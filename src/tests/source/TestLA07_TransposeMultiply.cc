...
int main(int argc, char* argv[]) {
    ...
    if (whetherToSubstractData == true) {
        ...
        if (!dispatcherClient.sendData<MatrixBlock>(
                std::pair<std::string, std::string>("LA_input_set2", "LA07_db"),
                storeMatrix2,
                errMsg)) {
            std::cout << "Failed to send data to dispatcher server" << std::endl;
            return -1;
    ...
    if (printResult == true) {
        ...
        SetIterator<MatrixBlock> input1 =
            myClient.getSetIterator<MatrixBlock>("LA07_db", "LA_input_set1");
        ...
        SetIterator<MatrixBlock> input2 =
            myClient.getSetIterator<MatrixBlock>("LA07_db", "LA_input_set2");
        ...
        SetIterator<MatrixBlock> result =
            myClient.getSetIterator<MatrixBlock>("LA07_db", "LA_product_set");
