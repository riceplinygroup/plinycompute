...
int main (int argc, char * argv[]) {
	...
	Handle <QueryOutput <PartialResult>> outputOne = makeObject <QueryOutput <PartialResult>> ("kmeans_db", "output_set1", myFirstSelect);
	...
	// print the resuts
	    ...
	    SetIterator <PartialResult> result = myClient.getSetIterator <PartialResult> ("kmeans_db", "output_set1");
