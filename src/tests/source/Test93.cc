...
int main (int argc, char * argv[]) {
       ...
       if (whetherToAddData == true) {
            ...
            if (!temp.createDatabase ("test93_db", errMsg)) {
            ...
            if (!temp.createSet<StringIntPair> ("test93_db", "test93_set1", errMsg)) {
            ...
            if (!temp.createSet<StringIntPair> ("test93_db", "test93_set2", errMsg)) {
                cout << "Not able to create set: " + errMsg;
                exit (-1);
            } else {
            ...
            if (!temp.createSet<StringIntPair> ("test93_db", "test93_set3", errMsg)) {
                cout << "Not able to create set: " + errMsg;
                exit (-1);
            } else {
            ...
            if (numOfMb > 0) {
                ...
                for (int num = 0; num < numIterations; num++) {
                    ...
                    try {
                        ...
                        if (!dispatcherClient.sendData<StringIntPair>(std::pair<std::string, std::string>("test93_set1", "test93_db"), storeMe, errMsg)) {
            ...
            if (numOfMb > 0) {
                ...
                for (int num = 0; num < numIterations; num++) {
                    ...
                    try {
                        ...
                        if (!dispatcherClient.sendData<StringIntPair>(std::pair<std::string, std::string>("test93_set2", "test93_db"), storeMe, errMsg)) {
                            std :: cout << "Failed to send data to dispatcher server" << std :: endl;
                            return -1;
                        }
                   }
            ...
            if (numOfMb > 0) {
                ...
                for (int num = 0; num < numIterations; num++) {
                    ...
                    try {
                        ...
                        if (!dispatcherClient.sendData<StringIntPair>(std::pair<std::string, std::string>("test93_set3", "test93_db"), storeMe, errMsg)) {
                            std :: cout << "Failed to send data to dispatcher server" << std :: endl;
                            return -1;
                        }
                   }
        ...
        if (!temp.createSet<String> ("test93_db", "output_set1", errMsg)) {
                cout << "Not able to create set: " + errMsg;
                exit (-1);
        } else {
                cout << "Created set.\n";
	...
	Handle <Computation> myJoin = makeObject <OptimizedMethodJoin> ();
        ...
        if (printResult == true) {
            ...
            SetIterator <String> result = myClient.getSetIterator <String> ("test93_db", "output_set1");
        ...
        if (clusterMode == false) {
            // and delete the sets
            myClient.deleteSet ("test93_db", "output_set1");
        } else {
            if (!temp.removeSet ("test93_db", "output_set1", errMsg)) {
