...
common_env.Program('bin/test4', ['src/tests/source/Test4.cc', component_dir_basename_to_cc_file_paths['objectModel']])
common_env.Program('bin/test5', ['src/tests/source/Test5.cc', component_dir_basename_to_cc_file_paths['objectModel']])
common_env.Program('bin/test6', ['src/tests/source/Test6.cc', component_dir_basename_to_cc_file_paths['objectModel']])
common_env.Program('bin/test7', ['src/tests/source/Test7.cc', component_dir_basename_to_cc_file_paths['objectModel']])
common_env.Program('bin/test8', ['src/tests/source/Test8.cc', component_dir_basename_to_cc_file_paths['objectModel']])
common_env.Program('bin/test9', ['src/tests/source/Test9.cc', component_dir_basename_to_cc_file_paths['objectModel']])
common_env.Program('bin/test10', ['src/tests/source/Test10.cc', component_dir_basename_to_cc_file_paths['objectModel']])
common_env.Program('bin/test11', ['src/tests/source/Test11.cc', component_dir_basename_to_cc_file_paths['objectModel']])
common_env.Program('bin/test12', ['src/tests/source/Test12.cc', component_dir_basename_to_cc_file_paths['objectModel']])
common_env.Program('bin/test13', ['src/tests/source/Test13.cc', component_dir_basename_to_cc_file_paths['bufferMgr'], component_dir_basename_to_cc_file_paths['objectModel']])
