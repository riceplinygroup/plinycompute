...
common_env.Program('bin/test32', ['src/tests/source/Test32.cc'] + all)
common_env.Program('bin/test33', ['src/tests/source/Test33.cc'] + all)
common_env.Program('bin/test34', ['src/tests/source/Test34.cc'] + all)
common_env.Program('bin/test35', ['src/tests/source/Test35.cc'] + all)
common_env.Program('bin/test36', ['src/tests/source/Test36.cc'] + all)
common_env.Program('bin/test37', ['src/tests/source/Test37.cc'] + all)
common_env.Program('bin/test38', ['src/tests/source/Test38.cc'] + all)
common_env.Program('bin/test39', ['src/tests/source/Test39.cc'] + all)
common_env.Program('bin/test40', ['src/tests/source/Test40.cc'] + all)
common_env.Program('bin/test41', ['src/tests/source/Test41.cc'] + all)
common_env.Program('bin/test42', ['src/tests/source/Test42.cc'] + all)
common_env.Program('bin/test43', ['src/tests/source/Test43.cc'] + all)
common_env.Program('bin/test44', ['src/tests/source/Test44.cc'] + all)
common_env.Program('bin/test45', ['src/tests/source/Test45.cc'] + all)
...
common_env.Program('bin/test603', ['src/tests/source/Test603.cc'] + all)
