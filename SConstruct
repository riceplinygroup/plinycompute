...
main=common_env.Alias('main', ['libraries/libAllSelection.so', 'libraries/libWriteDoubleSet.so', 'libraries/libScanSimpleEmployeeSet.so', 'libraries/libSimpleEmployee.so', 'libraries/libFinalSelection.so', 'libraries/libSimpleAggregation.so', 'libraries/libScanSupervisorSet.so', 'libraries/libSillySelection.so', 'libraries/libSillyAggregation.so', 'libraries/libWriteStringSet.so','libraries/libScanEmployeeSet.so','libraries/libEmployeeSelection.so','libraries/libKMeansQuery.so',  'libraries/libPartialResult.so', 'libraries/libSharedEmployeeTopK.so', 'bin/test75', 'bin/test74', 'bin/test73', 'bin/test72', 'bin/test71', 'bin/test70', 'bin/test69', 'bin/test68', 'bin/test67', 'bin/test66', 'bin/test65', 'bin/test64', 'bin/test63', 'bin/test62', 'bin/test60', 'bin/test58', 'bin/test57', 'bin/test56', 'bin/test54', 'bin/test53', 'bin/test47Join', 'bin/test47JoinB', 'bin/test47JoinC','bin/test47JoinD','bin/test47', 'bin/MasterServerTest', 'bin/CatalogServerTests','bin/pdb-server', 'bin/test46', 'bin/test44', 'libraries/libStringSelection.so', 'libraries/libChrisSelection.so', 'libraries/libSharedEmployee.so', 'bin/pdb-cluster', 'bin/test52', 'bin/test1', 'bin/test2', 'bin/test3', 'bin/test4', 'bin/test5', 'bin/test6', 'bin/test7', 'bin/test8', 'bin/test9', 'bin/test10', 'bin/test11', 'bin/test12', 'bin/test16', 'bin/pdbServer', 'bin/getListNodesTest', 'bin/objectModelTest1', 'bin/CatalogTests', 'bin/storeSharedEmployeeInDBTest', 'bin/registerTypeAndCreateDatabaseTest', 'bin/storeLotsOfEmployee' ])
Default(main)
