...
common_env.SharedLibrary('libraries/libLAAddJoin.so', ['build/libraries/LAAddJoin.cc'] + all)
common_env.SharedLibrary('libraries/libLAColMaxAggregate.so', ['build/libraries/LAColMaxAggregate.cc'] + all)
common_env.SharedLibrary('libraries/libLAColMinAggregate.so', ['build/libraries/LAColMinAggregate.cc'] + all)
common_env.SharedLibrary('libraries/libLAColSumAggregate.so', ['build/libraries/LAColSumAggregate.cc'] + all)
common_env.SharedLibrary('libraries/libLADuplicateColMultiSelection.so', ['build/libraries/LADuplicateColMultiSelection.cc'] + all)
common_env.SharedLibrary('libraries/libLADuplicateRowMultiSelection.so', ['build/libraries/LADuplicateRowMultiSelection.cc'] + all)
common_env.SharedLibrary('libraries/libLAInverse1Aggregate.so', ['build/libraries/LAInverse1Aggregate.cc'] + all)
common_env.SharedLibrary('libraries/libLAInverse2Selection.so', ['build/libraries/LAInverse2Selection.cc'] + all)
common_env.SharedLibrary('libraries/libLAInverse3MultiSelection.so', ['build/libraries/LAInverse3MultiSelection.cc'] + all)
common_env.SharedLibrary('libraries/libLAMaxElementAggregate.so', ['build/libraries/LAMaxElementAggregate.cc'] + all)
common_env.SharedLibrary('libraries/libLAMinElementAggregate.so', ['build/libraries/LAMinElementAggregate.cc'] + all)
common_env.SharedLibrary('libraries/libLAMultiply1Join.so', ['build/libraries/LAMultiply1Join.cc'] + all)
common_env.SharedLibrary('libraries/libLAMultiply2Aggregate.so', ['build/libraries/LAMultiply2Aggregate.cc'] + all)
common_env.SharedLibrary('libraries/libLARowMaxAggregate.so', ['build/libraries/LARowMaxAggregate.cc'] + all)
common_env.SharedLibrary('libraries/libLARowMinAggregate.so', ['build/libraries/LARowMinAggregate.cc'] + all)
common_env.SharedLibrary('libraries/libLARowSumAggregate.so', ['build/libraries/LARowSumAggregate.cc'] + all)
common_env.SharedLibrary('libraries/libLAScaleMultiplyJoin.so', ['build/libraries/LAScaleMultiplyJoin.cc'] + all)
common_env.SharedLibrary('libraries/libLASubstractJoin.so', ['build/libraries/LASubstractJoin.cc'] + all)
common_env.SharedLibrary('libraries/libLATransposeMultiply1Join.so', ['build/libraries/LATransposeMultiply1Join.cc'] + all)
common_env.SharedLibrary('libraries/libLATransposeSelection.so', ['build/libraries/LATransposeSelection.cc'] + all)
...
common_env.Program('bin/test75', ['build/tests/Test75.cc'] + all + pdb_client)
...
common_env.Program('bin/test91', ['build/tests/Test91.cc'] + all + pdb_client)
...
libLATest=common_env.Alias('libLATest', [
  ...
  'libraries/libLAAddJoin.so',
  'libraries/libLAColMaxAggregate.so',
  'libraries/libLAColMinAggregate.so',
  'libraries/libLAColSumAggregate.so',
  'libraries/libLADuplicateColMultiSelection.so',
  'libraries/libLADuplicateRowMultiSelection.so',
  'libraries/libLAInverse1Aggregate.so',
  'libraries/libLAInverse2Selection.so',
  'libraries/libLAInverse3MultiSelection.so',
  'libraries/libLAMaxElementAggregate.so',
  'libraries/libLAMinElementAggregate.so',
  'libraries/libLAMultiply1Join.so',
  'libraries/libLAMultiply2Aggregate.so',
  'libraries/libLARowMaxAggregate.so',
  'libraries/libLARowMinAggregate.so',
  'libraries/libLARowSumAggregate.so',
  'libraries/libLAScaleMultiplyJoin.so',
  'libraries/libLASubstractJoin.so',
  'libraries/libLATransposeMultiply1Join.so',
  'libraries/libLATransposeSelection.so',
